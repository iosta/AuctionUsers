        ...
        <div class="encuadre-informacion">
            ...
            <div class="botones-menu">
                ...
                <a href="ofrecidosadmin.html">
                    ...
                    <img class="imagenes-menu-usuario" src="img/ofrecer-productos.png"
                         alt="Imagen de ver productos ofertados">
                </a>
                <a href="#">
                    <p>Resetear catálogo</p>
                    <img class="imagenes-menu-usuario" src="img/resetear-productos.png"
                         alt="Imagen de resetear catálogo">
                </a>
                <a href="historialadmin.html">
                    <p>Historial ganadores</p>
                    <img class="imagenes-menu-usuario" src="img/ver-historial-pujas.png"
                         alt="Imagen de historial ganadores">
                </a>
                ...
                <a href="todo">
                    ...
                    <img class="imagenes-menu-usuario" src="img/gestion-usuarios.png"
                         alt="Imagen de Gestion de Usuarios">
                </a>
                <a href="index.html">
                    <p>Salir</p>
